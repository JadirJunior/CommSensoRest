...
export abstract class BaseController<M extends Model> implements IController {
    ...
    async getAll(req: Request, res: Response, next: NextFunction) : Promise<Response<M, Record<string, M>> | undefined> {
        try {
            const { id } = req.query;
    ...
    async create(req: Request, res: Response, next: NextFunction): Promise<Response<M, Record<string, M>> | undefined> {
        try {
    ...
    async deleteById(req: Request, res: Response, next: NextFunction): Promise<Response<M, Record<string, M>> | undefined> {
        try {
